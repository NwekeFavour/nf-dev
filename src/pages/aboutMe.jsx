    ...
    return (
        <div>
            ...
            <div className='md:w-[80%] mx-auto w-[90%]'>
                ...
                <div className=''>
                    <p className="m-0 text-gray-300 lg:text-[17px] sm:text-[16px] text-[15px] md:my-4 my-3">I'm <span className='text-gray-100'>Nweke Favour</span>, a frontend developer passionate about building fast, accessible, and visually clean web applications. With a focus on modern technologies like <span className='text-gray-100'>React.js, Next.js, and Vue.js</span>, I specialize in crafting intuitive user interfaces that balance form and function. From concept to deployment, I enjoy creating <span className='text-gray-100'>seamless experiences that solve real-world problems</span> and drive user engagement.</p>
                    <p className="m-0 text-gray-300 lg:text-[17px] sm:text-[16px] text-[15px] md:my-4 my-5">
                        My journey into tech started with a curiosity for how websites work, which quickly grew into a passion for building meaningful <span className='text-gray-100'>digital experiences</span>. What began as self-driven exploration has evolved into a focused practice of turning ideas into functional, <span className='text-gray-100'>user-centered interfaces</span>. I’m driven by the challenge of solving real problems through code and continuously strive to write clean, scalable, and efficient frontend solutions. Along the way, I’ve embraced <span className='text-gray-100'>modern workflows</span>, UI frameworks, and deployment practices that help me ship quality work with confidence.
                    </p>
                    <p className="m-0 text-gray-300 lg:text-[17px] sm:text-[16px] text-[15px] md:my-4 my-3">I thrive in environments that encourage creativity, <span className='text-gray-100'> collaboration, and continuous learning</span>. Whether working with a team or independently, I bring strong problem-solving skills, adaptability, and attention to detail to every project. I'm always seeking new challenges that push me to grow and build more polished, purposeful digital experiences.</p>
                </div>
            </div>
